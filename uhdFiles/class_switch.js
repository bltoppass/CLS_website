...
<br><br><br>\
<h2>CS 3300 Object Oriented Programming</h2>\
...
//each option in option tag will be identified by a value, this value will represent each var up above
function replace(someValue){
    if (someValue==""){
        return;//Select A Class
    }else if(someValue=="cs1410"){
        document.open();//opens the html as a document
        document.write(cs1410);//writes whatever the variable is as the document
        document.close();//closes the document so changes won't be made
    }else if(someValue=="cs2301"){
        document.open();
        document.write(cs2301);
        document.close();
    }else if(someValue=="cs2302"){
        document.open();
        document.write(cs2302);
        document.close();
    }else if(someValue=="cs2410"){
        document.open();
        ...
        document.close();
    }else if(someValue=="cs3304"){
        document.open();
        document.write(cs3304);
        document.close();
    }else if(someValue=="cs3306"){
        document.open();
        document.write(cs3306);
        document.close();
    }else if(someValue=="cs3321"){
        document.open();
        document.write(cs3321);
        document.close();
    }else if(someValue=="cs4300"){
        document.open();
        document.write(cs4300);
        document.close();
    }else if(someValue=="cs4303"){
        document.open();
        document.write(cs4303);
        document.close();
    }else if(someValue=="cs4315"){
        document.open();
        document.write(cs4315);
        document.close();
    }else if(someValue=="cs4318"){
        document.open();
